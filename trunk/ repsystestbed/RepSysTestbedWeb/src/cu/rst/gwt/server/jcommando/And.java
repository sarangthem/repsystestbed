 ...
 *
 */
public class And extends Grouping
{
   ...
   public boolean satisfied(Set optionSet)
   {
      ...
      while (iter.hasNext())
      {
         ...
         allSatisfied &= grouping.satisfied(optionSet);
      }

      return allSatisfied && allPresent(optionSet);
   }
   ...
   private boolean allPresent(Set optionSet)
   {
      return optionSet.containsAll(options);
   }
}
