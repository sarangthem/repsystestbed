...
public class PasteCommand implements Command
{
	...
	public PasteCommand(Set<Element> elements, Subnet currentSubnet,
			PetriNet petriNet)
	{
	...
	private Point calculateTranslatioToCenter(Set<Element> elements,
			Subnet currentSubnet)
	{
		...
		result.translate(Math.round(-(float) bounds.getCenterX()),
				Math.round(-(float) bounds.getCenterY()));
