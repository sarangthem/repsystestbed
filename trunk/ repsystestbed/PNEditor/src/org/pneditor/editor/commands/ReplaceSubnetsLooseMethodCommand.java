...
public class ReplaceSubnetsLooseMethodCommand implements Command
{
	...
	public ReplaceSubnetsLooseMethodCommand(Set<Subnet> subnets,
			Subnet storedSubnet, PetriNet petriNet)
	{
		for (Subnet subnet : subnets)
		{
			replaceSubnets.add(new ReplaceSubnetLooseMethodCommand(subnet,
