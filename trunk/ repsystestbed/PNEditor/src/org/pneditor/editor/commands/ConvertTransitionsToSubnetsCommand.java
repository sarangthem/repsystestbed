...
public class ConvertTransitionsToSubnetsCommand implements Command
{
	...
	public ConvertTransitionsToSubnetsCommand(Set<Transition> transitions,
			PetriNet petriNet)
	{
		for (Transition transition : transitions)
		{
			convertTransitionsToSubnets
					.add(new ConvertTransitionToSubnetCommand(transition,
							petriNet));
		}
	}
	...
	public String toString()
	{
		...
		{
			return CollectionTools.getFirstElement(convertTransitionsToSubnets)
					.toString();
		}
