			...
			if (root.getClickedElement() == null)
			{
				if (root.isSelectedTool_Place())
				{
					...
					root.getUndoManager().executeCommand(
							new AddPlaceCommand(root.getDocument().petriNet
									.getCurrentSubnet(), x, y, root
									.getDocument().petriNet, root.getDocument().workflow));
					root.setClickedElement(CollectionTools.getLastElement(root
