...
import cu.rst.core.graphs.Group;
import cu.rst.core.graphs.Group.TargetGpStrAssignment;
import cu.rst.core.graphs.Strategy;
...
public class FeedbackGenerator
{
	...
	static Logger logger = Logger.getLogger(FeedbackGenerator.class.getName());
	...
	public List<Feedback> generate(String propertiesFileName) throws Exception
	{
		...
		String strFileName = properties.getProperty(FeedbackGenerator.strategiesArffFileName);
		String grpFileName = properties.getProperty(FeedbackGenerator.groupArffFileName);
		String strGrpFileName = properties.getProperty(FeedbackGenerator.groupstrategiesAssignmentFileName);
