...
public class CachedGraphics2D extends Graphics2D
{
	...
	private Graphics graphics = new BufferedImage(1, 1,
	...
	{
		Rectangle stringBounds = getFontMetrics()
				.getStringBounds(str, graphics).getBounds();
		addRectangleToBounds(x, y - stringBounds.height, stringBounds.width,
				stringBounds.height);
		toBeDrawn.add(new Drawable()
		{
			public void draw(Graphics2D g)
