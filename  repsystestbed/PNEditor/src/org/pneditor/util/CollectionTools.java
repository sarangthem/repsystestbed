...
public class CollectionTools
{
	...
	public static boolean containsOnlyInstancesOf(Collection collection,
			Class clazz)
	{
	...
	public static <E> E getFirstElementNotIn(Collection<E> elements,
			Collection<E> restricted)
	{
		E firstElement = null;
		for (E element : elements)
		{
	...
	public static <E> Set<E> getElementsNotIn(Collection<E> elements,
			Collection<E> restricted)
	{
	...
	public static <E> Set<E> getFilteredByClass(Collection<?> elements,
			Class<E> clazz)
	{
