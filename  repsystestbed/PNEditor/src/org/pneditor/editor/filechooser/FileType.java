...
public abstract class FileType extends FileFilter
{
	...
	public abstract void save(Document document, File file)
	...
	public BufferedImage getPreview(File file)
	{
		try
		{
			...
			BufferedImage image = petriNet.getRootSubnet().getPreview(
	...
	{
		if (file.isDirectory())
		{ // Show also directories in the filters
			return true;
		}
	...
	public static FileType getAcceptingFileType(File file,
