...
public class PersonalizedET extends Algorithm
{
	...
	static Logger logger = Logger.getLogger(PersonalizedET.class.getName());
	
	
	
	public PersonalizedET()
	{
	...
	public void setConfig(Properties config)
	{
		if(config != null)
		{
			try
			{
				...
				Integer iterations = new Integer(config.getProperty(PersonalizedET.NUMITERATIONS));
